	...
	return (
		<div className="pb-0 md:pb-5 md:pt-12 pt-20">
			...
			<div>
				...
				<Spotlight className="h-[80vh] w-[50vw] top-10 left-full" fill="#374097" />
         ...
         bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"
			...
			<div className="flex justify-center relative my-20 z-10">
				<div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
					<p className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-full">Full Stack Engineer & Applied AI Developer</p>
					 ...
					 */}
					<TextGenerateEffect
						words="Designing and deploying scalable full stack and network intelligence systems"
